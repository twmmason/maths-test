...
export const PARTS_CATALOG: PartVariant[] = [
  ...
  { id: "cryo-tank", part: "fuelTank", name: "Cryo Tank Mk3", emoji: "⛽", unlockLevel: 3, description: "Super-chilled fuel packs more punch per litre.", stats: { tankFill: 0.85, fuelRatio: 3 } },
  // Engines
